...
| `docs/RUN_MODES.md` | Centralised launch guide covering packaged, module, and legacy entry points to minimise README merge conflicts. |
| `docs/merge_conflicts.md` | Tips for reconciling documentation conflicts when branches modify launch instructions. |
